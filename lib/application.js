...
var Application = Ember.Application.extend({
  ...
  init: function() {
    ...
    import TextFilterView from 'adminjs/views/text_filter';
    this.TextFilterView = TextFilterView;

    import CheckboxesFilterView from 'adminjs/views/checkboxes_filter';
    this.CheckboxesFilterView = CheckboxesFilterView;
    ...
    import TextEditorView from 'adminjs/views/text_editor';
